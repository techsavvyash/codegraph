...
// Usage:
//
//	INSPECT_FIXTURE=test/fixtures/tiny-go go test -run TestInspectFixture -v ./internal/ingest/scip/
...
func findRepoRoot(t *testing.T) string {
	...
	// file is internal/ingest/scip/fixture_inspect_test.go — walk up to repo root.
