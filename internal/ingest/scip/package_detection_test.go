...
func TestExtractGoModulePath(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			gomod:    "module github.com/example/service\n\ngo 1.24\n",
			expected: "github.com/example/service",
		},
		{
...
func TestDetectPackageNameGoUsesModulePath(t *testing.T) {
	dir := t.TempDir()
	gomod := "module github.com/context-maximiser/code-graph/internal/model\n\ngo 1.24\n"
	...
	expected := "github.com/context-maximiser/code-graph/internal/model"
	if got != expected {
